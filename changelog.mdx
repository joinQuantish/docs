...
* TypeScript `polynode-sdk` 0.14.1 provides a browser-memory session, standard
  viem provider typing, wallet-confirmed USDC.e → pUSD funding, exact order
  preview/signing, and authenticated open-order reconciliation.
* TypeScript 0.14.1, Python `polynode` 0.14.0, and Rust `polynode` 0.17.0 share
