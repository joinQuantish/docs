...
## 2026-03-29 — Trading Module v0.5.4 (TypeScript SDK)

### TypeScript SDK v0.5.4

- **EOA auto-approvals:** `ensureReady()` now automatically sends approval transactions for EOA wallets. Previously, EOA users were left with `approvalsSet: false` and no way to fix it. Requires ~$0.01 MATIC in the wallet.
