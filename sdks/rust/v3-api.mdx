...
Rust 0.17.1 exposes the complete shared V3 registry through `client.v3()`. Generic responses use `serde_json::Value`, preserving decimal strings and large integer wire values.
...
fn main() {
    println!("{V3_OPERATION_COUNT}"); // 120 in 0.17.1
