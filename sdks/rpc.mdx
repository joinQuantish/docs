...
The endpoint currently supports HTTP only, with a limit of 2 HTTP requests/second per client IP. WebSocket `eth_subscribe`/`newHeads` is not live on this endpoint.
