...
| --- | --- | ---: | --- |
| TypeScript / Node.js | [`polynode-sdk`](https://www.npmjs.com/package/polynode-sdk) | `0.12.2` | Node.js 18+ |
| Python | [`polynode`](https://pypi.org/project/polynode/) | `0.12.2` | Python 3.10+ |
| Rust | [`polynode`](https://crates.io/crates/polynode) | `0.15.2` | Tokio async runtime |
...
<Tabs>
  ...
  <Tab title="Python">
    ```bash
    python -m pip install --upgrade "polynode>=0.12.2"
    ```
  </Tab>
  <Tab title="Rust">
    ```toml
