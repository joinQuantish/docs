...
TypeScript 0.13.0 exposes the complete shared V3 operation registry at `pn.v3.operations`. Typed helpers cover common reads; `execute()` covers every registered route, including combos, credits, webhooks, and perps.
...
console.log(V3_OPERATION_COUNT); // 120 in 0.13.0
