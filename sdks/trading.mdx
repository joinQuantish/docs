...
<Warning>
Polymarket uses **USDC.e** (bridged USDC) on Polygon, NOT native USDC. These are different tokens at different contract addresses. If you send native USDC, it will not show up as a trading balance. The correct token is USDC.e at `0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174` on Polygon.
</Warning>
