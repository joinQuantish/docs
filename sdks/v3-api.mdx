...
Every SDK ships the same V3 operation registry. In TypeScript 0.13.0, Python 0.13.0, and Rust 0.16.0 it contains 120 operations, so new and less-common routes do not have to wait for a language-specific helper.
...
<Tabs>
  <Tab title="TypeScript">
    ...
    console.log(V3_OPERATION_COUNT); // 120 in polynode-sdk 0.13.0
  ...
  <Tab title="Python">
    ...
    print(V3_OPERATION_COUNT)  # 120 in polynode 0.13.0
  ...
  <Tab title="Rust">
    ...
    fn main() {
        println!("{V3_OPERATION_COUNT}"); // 120 in polynode 0.16.0
