...
Every SDK ships the same V3 operation registry. In TypeScript 0.14.0, Python 0.14.0, and Rust 0.17.0 it contains 120 operations, so new and less-common routes do not have to wait for a language-specific helper.
...
<Tabs>
  <Tab title="TypeScript">
    ...
    console.log(V3_OPERATION_COUNT); // 120 in polynode-sdk 0.14.0
