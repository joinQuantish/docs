...
sidebarTitle: "V3 API"
description: "Call the shared 120-operation V3 SDK registry and use authenticated REST for newer routes awaiting a registry release."
icon: "database"
---

Every SDK ships the same V3 operation registry. In TypeScript 0.14.2, Python 0.14.1, and Rust 0.17.1 it contains 120 operations.
...
The Builder trader leaderboard and the two Builder daily-activity routes are newer authenticated REST endpoints and are not part of the 120-operation registry in those versions. Call them over HTTPS using the examples in [Builder Trader P&L Leaderboard](/data/builders/trader-leaderboard), [Builder Daily Activity](/data/builders/daily-activity), and [Compare Builder Daily Activity](/data/builders/activity-comparison) until a later SDK release explicitly adds them.
...
<Tabs>
  <Tab title="TypeScript">
    ...
    console.log(V3_OPERATION_COUNT); // 120 in polynode-sdk 0.14.2
  ...
  <Tab title="Python">
    ...
    print(V3_OPERATION_COUNT)  # 120 in polynode 0.14.1
  ...
  <Tab title="Rust">
    ...
    fn main() {
        println!("{V3_OPERATION_COUNT}"); // 120 in polynode 0.17.1
