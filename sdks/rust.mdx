...
```toml
[dependencies]
polynode = { version = "0.7.0", features = ["trading", "cache"] }
...
<Note>Requires the `trading` feature flag: `polynode = { version = "0.7.0", features = ["trading"] }`</Note>
...
<Note>Requires the `privy` feature flag: `polynode = { version = "0.7.0", features = ["trading", "privy"] }`</Note>
...
<Note>Requires the `cache` feature flag: `polynode = { version = "0.7.0", features = ["cache"] }`</Note>
