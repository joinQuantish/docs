...
<Note>Requires the `trading` feature flag: `polynode = { version = "0.7.3", features = ["trading"] }`</Note>
...
<Note>Requires the `privy` feature flag: `polynode = { version = "0.7.3", features = ["trading", "privy"] }`</Note>
