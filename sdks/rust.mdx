...
```toml
[dependencies]
polynode = { version = "0.5.6", features = ["trading", "cache"] }
...
<Note>Requires the `trading` feature flag: `polynode = { version = "0.5.6", features = ["trading"] }`</Note>
...
<Note>Requires the `privy` feature flag: `polynode = { version = "0.5.6", features = ["trading", "privy"] }`</Note>
...
<Note>Requires the `cache` feature flag: `polynode = { version = "0.5.6", features = ["cache"] }`</Note>
