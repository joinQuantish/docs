...
Pick a coin and interval to get the current market slug. Updates live.

<div id="slug-calculator" style="padding:20px; border-radius:12px; border:1px solid rgba(128,128,128,0.2); margin:16px 0;"></div>

<Note>The `{timestamp}` in 5m and 15m slugs is the Unix epoch (seconds) of the window start, always aligned to the interval boundary. For example, a 15m window starting at 10:00:00 UTC has timestamp `1775397600`.</Note>
