...
Settlement events flow in real-time as trades happen:

```json Settlement Event
{
  "event_type": "settlement",
  "status": "pending",
  "market_slug": "btc-updown-15m-1774072800",
  "market_title": "Bitcoin Up or Down - March 21, 2:00AM-2:15AM ET",
  "outcome": "Down",
  "taker_side": "BUY",
  "taker_size": 12.5,
  "taker_price": 0.155
...
<Tip>In a 30-second window, the test stream received **227 settlement events** across 3 coins. These markets are very active.</Tip>
...
| 1 hour | `'1h'` / `Hourly` | 3600s | Discovered via series query |
...
time_remaining: 261s
markets: 2
  btc | btc-updown-5m-1774073700 | beat $70697.94 | 52% up | $24733 liq | $1476 vol
  eth | eth-updown-5m-1774073700 | beat $2153.39 | 52% up | $12446 liq | $288 vol

Events received in 20s: 936
```
