...
curl "https://api.polynode.dev/v2/onchain/trades?wallet=0x...&limit=2" -H "x-api-key: YOUR_KEY"

# walk to the next page
curl "https://api.polynode.dev/v2/onchain/trades?wallet=0x...&limit=2&pagination_key=2" -H "x-api-key: YOUR_KEY"
```
