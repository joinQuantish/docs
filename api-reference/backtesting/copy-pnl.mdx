...
<Warning>
This V2 on-demand endpoint is deprecated. Use the [V3 Copy PnL single-wallet endpoint](/data/wallets/copy-pnl). V3 uses up to 50,000 recent fills per wallet and normal V3 account limits. It has a different response shape and does not support V2 date windows or weighted-average position metrics. See the [migration notes](/data/wallets/copy-pnl#migrating-from-v2).
</Warning>
