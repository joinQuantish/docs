---
title: "Deprecated: Backtest Copy PnL"
openapi: "GET /v2/copy-pnl/{wallet}"
...
<Warning>
This V2 on-demand endpoint is deprecated. Use the [V3 Copy PnL single-wallet endpoint](/data/wallets/copy-pnl). V3 supports date windows, optional full-history calculation with explicit fallback, lifetime realized-PnL context, and normal V3 account limits. Its response shape and realized-PnL scope differ from V2; weighted-average position metrics are not reproduced. See the [migration notes](/data/wallets/copy-pnl#migrating-from-v2).
</Warning>
