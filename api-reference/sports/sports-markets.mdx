...
| `GET /v2/sports/games/by-event/{event_id}` | The same game detail resolved by Polymarket event ID |
| `GET /v2/sports/games/by-market/{market_id}` | The parent game detail resolved by Polymarket market ID |
