...
Every game-scoped endpoint also accepts an explicit Polymarket Gamma event ID or market ID. Use the explicit prefix because event IDs and market IDs are separate numeric namespaces.
