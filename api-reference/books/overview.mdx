...
# 3. Get every market for one game, filtered to moneyline on DraftKings and Polymarket
curl "https://books.polynode.dev/v1/games/nba-por-phx-2026-04-15/markets?market=moneyline&book=DraftKings,Polymarket&key=$KEY"
