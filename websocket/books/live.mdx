...
Notice the sequence: **welcome → snapshot → deltas**. The snapshot gives you the baseline state of all 11 currently-live games, then deltas flow from that point forward.
