...
3. **Receive snapshot frame** (JSON). Full state of every currently-live game. **This is your baseline** — initialize your in-memory view from this before processing any delta events. See [snapshot event](/websocket/books/events#snapshot).
