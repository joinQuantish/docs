...
<Steps>
  ...
  <Step title="What you'll see">
    ```
    Down  BUY    4.00 shares @ 0.71     | 0x673d4961... | Ethereum Up or Down - April 30, 1:15PM-1:20PM ET
    Up    BUY    4.26 shares @ 0.4085   | 0xa855bf8e... | Ethereum Up or Down - April 30, 1:15PM-1:20PM ET
    Yes   SELL  10.00 shares @ 0.946    | 0x1c06e4a2... | Highest temperature in Seoul on May 2?
    No    BUY    6.00 shares @ 0.999    | 0x993c0725... | Will WTI Crude Oil hit $70 in April?
    ```

    Every line is one trade. Pre-confirmation delivery, 3-5 seconds before on-chain settlement.
  </Step>
</Steps>
...
<details>
<summary>Settlement-based quick start (advanced)</summary>

If you need the full transaction format with nested fills and status lifecycle:
