...
|--------|---------|-----------|
| **Settlements** | Pending and confirmed Polymarket settlements (default) | `{"action": "subscribe", "type": "settlements"}` |
| **Trades** | All trade activity including confirmed on-chain trades | `{"action": "subscribe", "type": "trades"}` |
