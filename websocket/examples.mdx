...
This unchanged subscription follows the default Chainlink stream. See
[Chainlink TWAP Prices](/crypto/twap) to select the 30-second window, the
60-second window, or both during the August transition.
