...
<ResponseField name="wallets" type="string">
  Events: `settlement`, `trade`, `position_change`, `deposit`, `status_update`

  All activity for specific wallets. Best used with the `wallets` filter.
</ResponseField>

<ResponseField name="markets" type="string">
  Events: `settlement`, `trade`, `position_change`, `status_update`
...
<ResponseField name="global" type="string">
  ...
  Unfiltered stream of every event (**firehose**). High throughput — use with caution. This counts toward your plan's firehose connection limit.
</ResponseField>
...
<ParamField body="event_types" type="string[]">
  ...
  `"settlement"`, `"trade"`, `"status_update"`, `"block"`, `"position_change"`, `"deposit"`
</ParamField>
