...
| `proxy` | Older accounts that signed up with an email login — these got a Polymarket Proxy. | Resolved automatically — see below. |
...
```json
{
  "input": "0xf0318c32136c2db7fec88b84869aee6a1106c80c",
  "wallet_type": "proxy",
  "signer": "0x14dd4e61e9559e47277ffd19528ce8403ad9e861",
  "registered": false
}
```
...
```json
{
  ...
  "detail": "this is a Polymarket Proxy wallet (email-login accounts); its owner isn't in the owner index yet — pass the account's signer address directly",
  "address": "0x..."
}
```
