...
These are the plan defaults; individual keys can carry a custom allowance. The hello frame you receive on connect reports **your key's exact `max_subscriptions`** — treat that as authoritative.
