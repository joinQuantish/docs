...
The number of tokens you can subscribe to depends on your tier:

| Tier | Max tokens | Estimated bandwidth |
|------|-----------|-------------------|
| **Free** | 20 (10 markets) | ~4 KB/s |
| **Starter** | 200 (100 markets) | ~40 KB/s |
| **Growth** | 4,000 (2,000 markets) | ~512 KB/s |
| **Enterprise** | Unlimited (all markets) | ~1.2 MB/s compressed |
...
<Note>
  Free tier includes a 1-hour daily session limit. Upgrade at [polynode.dev/pricing](https://polynode.dev/pricing) for unlimited access.
</Note>
