...
|-------|----------|-----------|
| `affShareBps: 10000` (default — all to builder) | $0.00 | $0.10 |
...
const trader = new PolyNodeTrader({
  ...
  feeConfig: {
    ...
    affiliate: '0xYourWallet...',           // your wallet — receives 100% of fee by default
    affiliateShareBps: 7000,              // optional: share 30% with polynode treasury
  },
});
```
