...
PolyUSD (pUSD) is the collateral token for Polymarket's V2 exchange system. It is a 1:1 wrapper around USDC.e on Polygon with 6 decimals. To trade on V2, you need PolyUSD instead of USDC.e.
