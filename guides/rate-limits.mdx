...
The wallet and market data endpoints (positions, trades, P&L) have a separate shared throughput limit of **20 requests per second** across all users. This applies to:
