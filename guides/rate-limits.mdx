...
| | Free | Developer ($49/mo) | Pro ($99/mo) |
|--|------|-----------|-----|
| **Rate limit** | 120 req/min (2 QPS) | 6,000 req/min (100 QPS) | 18,000 req/min (300 QPS) |
| **WebSocket connections** | 1 | 10 | Unlimited |
| **API keys** | 1 | 3 | 10 |
| **JSON-RPC proxy** | No | Yes | Yes |
| **Snapshot size** | 20 | 100 | 200 |
| **Key generation** | 1 per IP per day | Via dashboard | Via dashboard |
...
Upgrade your plan at [polynode.dev/pricing](https://polynode.dev/pricing) for higher rate limits, more WebSocket connections, and JSON-RPC proxy access.
