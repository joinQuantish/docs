...
cargo add polynode@0.16.0 --features trading
npm install polynode-sdk@^0.13.0
...
onboarding, use TypeScript `polynode-sdk >= 0.13.0`, Python
`polynode >= 0.13.0,<0.14`, or Rust `polynode >= 0.16.0` with the `trading`
feature. Current registry releases are TypeScript `0.13.6`, Python `0.13.0`,
and Rust `0.16.0`.
</Accordion>
