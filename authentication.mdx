...
The [usage dashboard](https://polynode.dev/dashboard/usage) is authenticated by your signed-in account; you do not submit a raw API key to view it. See [Usage and Allowances](/usage/overview) for the exact meters and included plan capacity.
