...
<Warning>
  **Chainlink TWAP transition:** production 30-second and 60-second TWAP testing
  begins August 4, 2026. Affected crypto up-or-down markets and polynode's
  default Chainlink price stream switch to TWAP on August 7, 2026 at 00:00 UTC.
  See [Chainlink TWAP Prices](/crypto/twap) for the exact schedule, subscription
  filters, and additive event fields.
</Warning>
