...
The included fee is specifically the collateral-denominated exchange fee
recorded in each signed order's `OrderFilled.fee`. It increases BUY cost or
...
Standard spot [Wallet P&L](/data/wallets/pnl) excludes separately reported
