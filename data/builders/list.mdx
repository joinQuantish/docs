...
| `GET /v3/builders/activity/daily` | Compare daily activity for selected builders plus exact Other |
| `GET /v3/builders/{code}/activity/daily` | Daily activity for one builder |
