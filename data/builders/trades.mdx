...
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?token_id=21578184864194020862792310253337084708609281967112790860038966988826118995357&limit=10"
```
...
```bash
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?market_slug=dota2-tundra-xtreme-2026-05-22-game1&limit=10"
```
...
```bash
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?side=buy&limit=10"
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?side=sell&limit=10"
```
...
```bash
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?market_slug=dota2-tundra-xtreme-2026-05-22-game1&tag_slug=sports&limit=10"
curl -H "x-api-key: $POLYNODE_API_KEY" \
  "https://api.polynode.dev/v3/builders/0x4898df15ec6590495dc6c0fedf951ade3e64001d47f9caf44a64e86fc11959df/trades?market_slug=dota2-tundra-xtreme-2026-05-22-game1&category=Sports&limit=10"
```
...
| `GET /v3/builders/{code}/leaderboard` | Rank this Builder's active trader cohort |
| `GET /v3/builders/{code}/activity/daily` | Daily attributed activity for this Builder |
