...
<CardGroup cols={2}>
  ...
  <Card title="Combo P&L Leaderboard" href="/data/combos/leaderboard">
    Global realized-P&L windows and marked All Time rankings with explicit coverage.
  </Card>
  <Card title="Combo Redemptions" href="/data/query-catalog/combos/redemptions">
    Full redemptions, partial reductions, and exact combo lineage.
  </Card>
  ...
  <Card title="Wallet Combo Redemptions" href="/data/query-catalog/combos/wallet-redemptions">
    Full and partial combo redemption history for one wallet.
  </Card>
