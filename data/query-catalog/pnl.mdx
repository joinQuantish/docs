...
<CardGroup cols={2}>
  ...
  <Card title="Global P&L Leaderboard" href="/data/query-catalog/pnl/global-leaderboard">
    Rank wallets all-time or by 1-day, 7-day, and 30-day realized P&L, globally or within one category or tag.
  </Card>
  <Card title="Tag P&L Leaderboard" href="/data/query-catalog/pnl/tag-leaderboard">
    Rank wallets inside one tag using all-time metrics or rolling realized P&L.
  </Card>
</CardGroup>
