...
<Note>
This endpoint does not currently include PolyUSD ERC-20 deposits or withdrawals. It is the indexed conditional-token activity feed for splits, merges, neg-risk conversions, and redemptions.
</Note>
