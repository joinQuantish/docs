...
description: "Query the complete Polymarket V1 + V2 database. 1.2 billion fills, 228 million positions, 2.7 million wallets. Real-time P&L, position tracking, builder analytics, and market data."
---

The Data API gives you direct access to the most complete Polymarket database in existence. Every trade, position, redemption, split, merge, and builder attribution across both V1 and V2 of the exchange, indexed from on-chain data and enriched with market metadata, token prices, and computed P&L.
